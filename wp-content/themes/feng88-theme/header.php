    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <div class="logo-container">
                <a class="navbar-brand site-logo" href="<?php bloginfo('url'); ?>"><img src="wp-content/uploads/2020/08/logo.svg" alt="Студия фен-шуй Гармония"></a>
            </div>
            <div class="slogan-container">
                <h1>Студия фэн-шуй <br> <span>Гармония</span></h1>
            </div>
